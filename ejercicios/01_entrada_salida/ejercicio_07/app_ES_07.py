...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        respuesta = "El resultado de la suma es:{0}". format (resultado)
        alert(title="calculadora", message=respuesta)
    ...
    def btn_restar_on_click(self):
        ...
        operador_b = int (operador_a)
        resultado = operador_a - operador_b
        respuesta = "El resultado de la resta es:{0}". format (resultado)
        alert(title="calculadora", message=respuesta)
    ...
    def btn_multiplicar_on_click(self):
        ...
        operador_b = int (operador_a)
        resultado = operador_a * operador_b
        respuesta = "El resultado de la multiplicacion es:{0}". format (resultado)
        alert(title="calculadora", message=respuesta)
    ...
    def btn_dividir_on_click(self):
        ...
        resultado = operador_a / operador_b
        respuesta = "El resultado de la division es:" + resultado .__str__()
        alert(title="calculadora", message=respuesta)
